...
ggplot(category_summary, aes(x = category)) +
  ...
  labs(title = "Mean Lead Time and Conversion Rate by Category",
       x = "Category",
       y = "Value") +
...
```{r}
# Box plots of lead time and conversion rate by category
ggplot(cleaned_data, aes(x = category)) +
  ...
  labs(title = "Box Plots of Lead Time and Conversion Rate by Category",
       x = "Category",
       y = "Value") +
...
```{r}
# Side-by-side bar plots of mean lead time and conversion rate by category
category_summary %>%
